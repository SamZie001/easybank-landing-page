...
const Footer = () => {
  ...
  return (
    <div className="bg-primary mt-auto py-9 px-3 md:px-4">
      <div className="container flex flex-col md:flex-row justify-center md:justify-between md:gap-5 h-auto md:h-28">
        <div className="flex flex-col md:flex-row items-center md:items-start">
          <div className="h-full flex flex-col justify-normal md:justify-between gap-5 md:gap-8">
        ...
        <div className="h-full md:py-5 flex flex-col justify-normal md:justify-between items-center md:items-end gap-3 md:gap-10 w-full md:w-1/3">
